...
public:
    void onMessage(stackchat::Room& r, const stackchat::ChatEvent& ev, const std::vector<std::string>&) override {
        r.reply(ev, R"(It's a well-known fact that Americans have a bit of a struggle when it comes to using the metric system. Despite the rest of the world using this logical, easy-to-understand system of measurement, Americans still insist on using their outdated imperial units.
